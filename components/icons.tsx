...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311V21m-3.75-2.311V21m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z" />
    </svg>
);

export const StorefrontIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0 1 14.25 12h.01a.75.75 0 0 1 .75.75v7.5m0 0H15M15 21a.75.75 0 0 0 .75-.75v-7.5a.75.75 0 0 0-.75-.75h-.01a.75.75 0 0 0-.75.75v7.5m0 0H12m0 0a.75.75 0 0 1-.75-.75v-7.5a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 .75.75v7.5m0 0H9m3.75 0a.75.75 0 0 0-.75-.75v-7.5a.75.75 0 0 0 .75-.75h.01a.75.75 0 0 0 .75.75v7.5m0 0H15m0 0a.75.75 0 0 1 .75-.75v-7.5a.75.75 0 0 1-.75-.75h-.01a.75.75 0 0 1-.75.75v7.5m-3.75 0a.75.75 0 0 0 .75-.75v-7.5a.75.75 0 0 0-.75-.75H12a.75.75 0 0 0-.75.75v7.5a.75.75 0 0 0 .75.75m0 0h.01M12 12h.01M12 12v-1.5m0 1.5v-1.5m0 0v-1.5m0 1.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm0 0V9m0 3v-1.5m0 0v-1.5m0 0V9m0 3a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm0 0V9m0 3v-1.5m0 0v-1.5m0 0V9m0 0a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-.75.75H12a.75.75 0 0 1-.75-.75V9m0 0v-1.5m0 1.5a.75.75 0 0 0-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 0 0 .75-.75v-.01a.75.75 0 0 0-.75-.75H12Zm0 0h.01M6.375 21v-6.75a.75.75 0 0 0-.75-.75H3.75a.75.75 0 0 0-.75.75v6.75c0 .414.336.75.75.75h2.25a.75.75 0 0 0 .75-.75Zm0 0v-6.75a.75.75 0 0 1 .75-.75h3.75a.75.75 0 0 1 .75.75v6.75c0 .414-.336.75-.75.75h-2.25a.75.75 0 0 1-.75-.75Zm0 0v-6.75a.75.75 0 0 0-.75-.75H3.75a.75.75 0 0 0-.75.75v6.75c0 .414.336.75.75.75h2.25A.75.75 0 0 0 6.375 21Zm0 0v-6.75a.75.75 0 0 1 .75-.75h3.75a.75.75 0 0 1 .75.75v6.75c0 .414-.336.75-.75.75h-2.25a.75.75 0 0 1-.75-.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.875 21.75l.525-2.25m-.525 2.25-.525-2.25m.525 2.25L3 18.75m1.875 3L3 18.75m0 0l2.25-2.25m-2.25 2.25L.75 16.5m2.25 2.25L.75 16.5M6 6.375l2.25-2.25M6 6.375l-2.25-2.25M6 6.375l2.25 2.25M6 6.375l-2.25 2.25M12 6.375l2.25-2.25M12 6.375l-2.25-2.25M12 6.375l2.25 2.25M12 6.375l-2.25 2.25M18 6.375l2.25-2.25M18 6.375l-2.25-2.25M18 6.375l2.25 2.25M18 6.375l-2.25 2.25m-12 12l2.25-2.25m-2.25 2.25l2.25 2.25M6 18.75l2.25 2.25m-2.25-2.25L3.75 16.5m2.25 2.25L3.75 16.5m12 12l2.25-2.25m-2.25 2.25l2.25 2.25m0 0l2.25-2.25m-2.25 2.25L15.75 16.5m2.25 2.25L15.75 16.5" />
    </svg>
);
...
export const AspectRatioIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 7H3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1zm-1 8H4V9h16v6z" />
    </svg>
);
